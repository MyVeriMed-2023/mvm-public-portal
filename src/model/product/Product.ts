...
export class Product {
  ...
  constructor(product?: any) {
      ...
      this.date_de_la_declaration_de_commercialisation = product?.date_de_la_declaration_de_commercialisation || '';
      this.etat_de_commercialisation_de_la_presentation = product?.etat_de_commercialisation_de_la_presentation || '';
      this.indications_ouvrant_droit_au_remboursement = product?.indications_ouvrant_droit_au_remboursement || '';
      ...
      this.product_cis = product?.product_cis ? new ProductCIS(product.product_cis) : new ProductCIS();
      this.product_info = product?.product_info?.map((info: any) => new ProductInfo(info)) || [];
